...
&& wget ${PLUGIN_CXX_DOWNLOAD_URL}/cxx-${PLUGIN_CXX_VERSION}/${PLUGIN_CXX_NAME}-${PLUGIN_CXX_VERSION}.${PLUGIN_CXX_PATCH}.jar -O ${SONAR_EXTENSIONS_PATH}/${PLUGIN_CXX_NAME}-${PLUGIN_CXX_VERSION}.jar \
