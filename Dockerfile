...
ENV SONAR_EXTENSIONS_PATH=/opt/sonarqube/extensions/plugins \
    SONAR_WEB_JAVAADDITIONALOPTS="-javaagent:${SONAR_EXTENSIONS_PATH}/${PLUGIN_BRANCH_NAME}-${PLUGIN_BRANCH_VERSION}.jar=web" \
    SONAR_CE_JAVAADDITIONALOPTS="-javaagent:${SONAR_EXTENSIONS_PATH}/${PLUGIN_BRANCH_NAME}-${PLUGIN_BRANCH_VERSION}.jar=ce"
